...
A comprehensive Python toolkit for processing images using Ollama's vision models to generate detailed descriptions and extract metadata. The project includes both an image description system and a HEIC to JPG converter utility.
